    ...
    async loadGlobalAnimations() {
        ...
        return await new Promise<void>(async (resolve) => {
            ...
            const anims = await Promise.all([
                this.loader.loadAsync("/models/456@walking_forward.glb"),               
                this.loader.loadAsync("/models/456@walking_backward.glb"),               
                this.loader.loadAsync("/models/456@idle_rifle.glb"),               
                this.loader.loadAsync("/models/456@walking_right.glb"),               
                this.loader.loadAsync("/models/456@walking_left.glb"),               
                this.loader.loadAsync("/models/456@running.glb"),               
                this.loader.loadAsync("/models/456@fire_rifle.glb"),               
            ]);
    
            this.globalAnimations = {
                "Walk" : anims[0].animations[0],               
                "Backward" : anims[1].animations[0],
                "IdleRifle" : anims[2].animations[0],
                "WalkRight" : anims[3].animations[0],
                "WalkLeft" : anims[4].animations[0],
                "Running" : anims[5].animations[0],
